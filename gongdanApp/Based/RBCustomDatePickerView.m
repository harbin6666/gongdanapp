...
{
    nowPickerShowTimeLabel = [[UILabel alloc] initWithFrame:CGRectMake(17.0, 220.0, 278.5, 18)];
    ...
    timeBroadcastView = [[UIView alloc] initWithFrame:CGRectMake(20, 20, 278.5, 190.0)];
...
{
    BOOL isBelowIOS7 = [[[UIDevice currentDevice] systemVersion] doubleValue] < 7.0;
